...
// Helper to clean up your public user object
...
// Routes
router.post("/request-otp", validate(phoneSchema), requestOtpHandler);
router.post("/verify-otp", validate(verifySchema), verifyOtpHandler);

// FIXED: Direct mapping instead of redirects
router.post("/register", validate(phoneSchema), requestOtpHandler);
router.post("/login", validate(verifySchema), verifyOtpHandler);
